...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT / "Figures_test", help="file/dir/URL/glob/screen/0(webcam)")
    parser.add_argument("--data", type=str, default=ROOT / "data/Oracle_dataset.yaml", help="(optional) dataset.yaml path")
